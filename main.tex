...
In a fully replicated and fault tolerant setting, we achieved $12.9x$ the throughput of a naive sequential approach with just 8 cores per execution server in our microbenchmarks.
